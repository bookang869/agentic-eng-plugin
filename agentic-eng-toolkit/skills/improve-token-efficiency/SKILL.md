...
> When installed as a plugin, the `${CLAUDE_PLUGIN_ROOT}` env var points at the plugin root. If it's unset, run `scripts/analyze_sessions.py` directly from the same folder as this SKILL.md.
